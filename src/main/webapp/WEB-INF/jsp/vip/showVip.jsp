...
<body>
    ...
    <form class="layui-form layui-form-pane" action="" style="display: inline-block;float: none;">
    ...
    <!--数据表格展示-->
    <div align="center" style="float: left;margin-left: 70px;">
...
<script type="text/html" id="genderTpl">
    {{#  if(d.gender == 1){ }}
        <input type="checkbox" checked="" name="gender" value="{{d.id}}" lay-skin="switch" lay-filter="switchTest" lay-text="男|女">
    {{#  } else { }}
        <input type="checkbox" name="gender" value="{{d.id}}" lay-skin="switch" lay-filter="switchTest" lay-text="男|女">
    {{#  } }}
</script>
