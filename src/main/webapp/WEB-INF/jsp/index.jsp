...
<div class="layui-layout layui-layout-admin">
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-right">
			...
			<li class="layui-nav-item" style="margin-left: 40px;"><iframe name="weather_inc" src="http://i.tianqi.com/index.php?c=code&id=36&icon=5&num=5&py=wuhan" width="300" height="25" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" ></iframe></li>
			<li class="layui-nav-item">
			...
			<ul class="layui-nav hp-nav-none">
				<li class="layui-nav-item">
					<a href="javascript:;"  class="hp-user-name">
						<img src="imge/41.png" class="layui-circle-img layui-anim-upbit">
	...
	<div class="layui-body">
		<!-- 内容主体区域 -->
		<div class="layui-tab hp-tab"  lay-filter="hp-tab-filter" lay-allowclose="true">
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<%--<div class="layui-carousel" id="test1">
						<div carousel-item style="height: 750px;">
							<div>
								<div class="demo-carousel">
									<p style="font-size: 30px;">韩氏集团酒店管理系统</p>
						...
						<div class="layui-carousel demo-carousel" id="test1">
							<div carousel-item style="height: 850px;">
								<div><img src="imge/1.png" width="100%";height="100%"></div>
								<div><img src="imge/2.png" width="100%";height="100%"></div>
								<div><img src="imge/3.png" width="100%";height="100%"></div>
								<div><img src="imge/4.png" width="100%";height="100%"></div>
								<div><img src="imge/5.png" width="100%";height="100%"></div>
								</button>
							</div>
						</div>
				</div>
